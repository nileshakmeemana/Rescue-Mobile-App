...
class _ProfileTabState extends State<ProfileTab> {
  ...
  void _updateUser(Map<String, String> data) => setState(() => _userData = data);
                ...
                child: Column(children: [
                  ...
                  _SettingsTile(
                    ...
                    trailing: Switch.adaptive(
                      ...
                      onChanged: (v) => setState(() => _interfaceToggle = v)),
                    onTap: () => setState(
                        () => _interfaceToggle = !_interfaceToggle)),
                  _div(),
                  ...
                  _SettingsTile(
                    ...
                    subtitle: 'Notifications will be sent to your email.',
                    trailing: Switch.adaptive(
                    ...
                    onTap: () => setState(
                        () => _notificationsToggle = !_notificationsToggle)),
                  _div(),
  ...
  void _showHelp(BuildContext ctx) {
    showDialog(context: ctx, builder: (_) => AlertDialog(
      ...
      title: Text('Help Center', style: GoogleFonts.inter(fontWeight: FontWeight.w700)),
      content: Text('For support, contact us at:\nhelp@rescue.app\nor call +94 11 234 5678',
          style: GoogleFonts.inter(color: const Color(0xFF8E8E93), height: 1.6)),
  ...
  void _showDonations(BuildContext ctx) {
    showDialog(context: ctx, builder: (_) => AlertDialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      title: Text('Send Donations', style: GoogleFonts.inter(
          fontWeight: FontWeight.w700)),
      content: Text('Help us support emergency response.\nDonate via bank transfer:\nAcc: 1234 5678 9012\nBank: People\'s Bank',
          style: GoogleFonts.inter(color: const Color(0xFF8E8E93), height: 1.6)),
      actions: [ElevatedButton(
        onPressed: () => Navigator.pop(ctx),
        style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFE53935),
  ...
  void _confirmDelete(BuildContext ctx) {
    showDialog(context: ctx, builder: (_) => AlertDialog(
      ...
      content: Text(
          ...
          style: GoogleFonts.inter(color: const Color(0xFF8E8E93), height: 1.5)),
      actions: [
...
class _SettingsTile extends StatelessWidget {
  ...
  const _SettingsTile({required this.icon, required this.title,
    this.subtitle, required this.trailing, required this.onTap});
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(title, style: GoogleFonts.inter(fontSize: 15,
                fontWeight: FontWeight.w600, color: const Color(0xFF1C1C1E))),
            if (subtitle != null) ...[
              const SizedBox(height: 2),
              Text(subtitle!, style: GoogleFonts.inter(fontSize: 12,
                  color: const Color(0xFF8E8E93), height: 1.4)),
            ],
          ])),
        trailing,
      ]),
