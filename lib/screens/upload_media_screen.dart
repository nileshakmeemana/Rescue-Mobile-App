...
class UploadMediaScreen extends StatefulWidget {
  ...
  @override State<UploadMediaScreen> createState() => _UploadMediaScreenState();
}
...
class _UploadMediaScreenState extends State<UploadMediaScreen>
  ...
  String get _title {
    switch (widget.type) {
      case MediaType.photo: return 'Upload Photo';
      case MediaType.video: return 'Upload Video';
      case MediaType.voice: return 'Upload Voice';
    }
  }
    ...
    if (widget.type == MediaType.voice) {
      ...
      if (_isRecording) {
        Future.delayed(const Duration(seconds: 2), () {
          if (mounted) setState(() { _isRecording = false; _captured = true; });
        });
      }
    } else {
      ...
      body: SafeArea(
        child: Column(children: [
          ...
          Padding(
            ...
            child: Text(_hint, textAlign: TextAlign.center,
              style: GoogleFonts.inter(fontSize: 13,
                  color: const Color(0xFF8E8E93), height: 1.5)),
          ),
          ...
          Padding(
            ...
            child: AnimatedBuilder(animation: _pulse, builder: (_, child) {
...
class _CameraPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: captured ? const Color(0xFFD1D1D6).withOpacity(0.6)
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.05),
            blurRadius: 8)]),
      child: Row(children: [
        Icon(hasAudio ? Icons.play_arrow : Icons.mic_none,
            size: 22, color: const Color(0xFF1C1C1E)),
        const SizedBox(width: 12),
        Text('Recorded Audio', style: GoogleFonts.inter(
