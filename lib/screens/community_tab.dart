...
class _CommunityTabState extends State<CommunityTab> {
  // Fix 3: user posts live in AppState
  ...
  Future<void> _openAddPost() async {
    // Fix 3: AddPostScreen writes to AppState directly
    await Navigator.push(context,
        MaterialPageRoute(builder: (_) => const AddPostScreen()));
  }

  void _deleteUserPost(int i) => AppState().removeUserPost(i);
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: AppState(),
      builder: (_, __) {
        final regional = AppState().regionalPosts;
        final region = AppState().region;
        // User posts first, then regional
        final userPosts = AppState().userPosts;
        final allPosts = [...userPosts, ...regional];
        ...
        return Scaffold(
          ...
          body: SafeArea(child: CustomScrollView(slivers: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (region.isNotEmpty)
                    Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text(region, style: GoogleFonts.inter(
                          fontSize: 11, color: const Color(0xFFE53935),
                          fontWeight: FontWeight.w500)),
                    ]),
                ]),
                const Spacer(),
                // Post button (red pill)
                GestureDetector(
                  onTap: _openAddPost,
                  child: Container(
                    ...
                    child: Text('Post', style: GoogleFonts.inter(
            ...
            SliverToBoxAdapter(child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 20, 20, 0),
              child: Text('Posts', style: GoogleFonts.inter(
                    ...
                    sliver: SliverGrid(
                      delegate: SliverChildBuilderDelegate(
                        (_, i) {
                          ...
                          // user-added posts have delete; regional don't
                          final isUserPost = i < userPosts.length;
                          return _PostCard(
                            post: post,
                            isUserPost: isUserPost,
                            onDelete: isUserPost
                                ? () => _deleteUserPost(i) : null,
            ...
            SliverToBoxAdapter(child: Padding(
              ...
              child: Text('Advertisements', style: GoogleFonts.inter(
                  fontSize: 18, fontWeight: FontWeight.w700,
                  color: const Color(0xFF1C1C1E))))),
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                delegate: SliverChildBuilderDelegate(
                  (_, i) => _AdCard(ad: Map<String, dynamic>.from(_ads[i])),
...
// ── Post Card with optional delete button for user posts ──────────────────────
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Expanded(child: Stack(children: [
            Container(
              ...
              child: Center(child: Icon(Icons.image_outlined,
                  size: 38, color: color))),
            // Fix 3: Delete button only on user-added posts
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
              Text(post['title'] as String, style: GoogleFonts.inter(
...
class _AdCard extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Container(
    ...
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Icon(ad['icon'] as IconData, size: 44,
          color: Colors.white.withOpacity(0.9)),
      const SizedBox(height: 8),
      Text(ad['label'] as String, style: GoogleFonts.inter(
